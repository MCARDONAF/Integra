...
<link rel="stylesheet" href="<?php echo e(asset('css/numerologia.css')); ?>">
    
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
    <div class="banner-taro">
        <h1>Signos Zodicales</h1>
    </div>
    ...
    <script>
        ...
        numeros.map(signos =>{
            numero += `<div onclick="mesage('${signos.nombreSigno}')" class="card-signo"><h2>${signos.nombreSigno}</h2> </div>`
        })
        ...
        const mesage=(signo)=>{
            location.href =`/zodiacal/${signo}`;
        }
    
    </script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\msnar\OneDrive\Escritorio\proyecto-personal\esoterismo\resources\views/signosZodiacales.blade.php ENDPATH**/ ?>