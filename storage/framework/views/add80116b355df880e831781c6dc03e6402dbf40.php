...
<?php $__env->startSection('title', __('Zodical')); ?>

<?php $__env->startSection('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/zodical.css')); ?>">
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
    <div class="container-cont">
        <div class="banner-taro">
            <img class="line-separator" src="<?php echo e(asset('img/line-tob.png')); ?>" alt="">
            <div class="conten-info">
                <h1>Pronóstico mensual <br> de <?php echo e($signo); ?></h1>
                <img src="<?php echo e(asset('img/leo.png')); ?>" alt=""> 
            </div>
            <img class="line-separator" src="<?php echo e(asset('img/line-bottom.png')); ?>" alt="">
        </div>

        <h1 class="title-sig"><?php echo e($signo); ?></h1>
        ...
        <div class="content-info-zodical">
            <div class="zodical-info">
                <div class="prediccion">
                    ...
                    <p><?php echo e($futuro); ?></p>
                    <img class="line-prediccion" src="<?php echo e(asset('img/line-bottom.png')); ?>" alt="">
                </div>
                ...
                <div class="prediccion">
                    <h3>Trabajo</h3>
                    <p><?php echo e($trabajo); ?></p>
                    <img class="line-prediccion" src="<?php echo e(asset('img/line-bottom.png')); ?>" alt="">
                </div>

                <div class="prediccion">
                    <h3>Salud</h3>
                    <p><?php echo e($salud); ?></p>
                    <img class="line-prediccion" src="<?php echo e(asset('img/line-bottom.png')); ?>" alt="">
                </div>

                <div class="prediccion">
                    <h3>Dinero</h3>
                    <p><?php echo e($dinero); ?></p>
                    <img class="line-prediccion" src="<?php echo e(asset('img/line-bottom.png')); ?>" alt="">
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\msnar\OneDrive\Escritorio\proyecto-personal\esoterismo\resources\views/zodical.blade.php ENDPATH**/ ?>